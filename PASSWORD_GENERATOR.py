...
#
val = IntVar()
spinlenght = Spinbox(root, from_=2, to_=30, textvariable=val, width=18).pack()
...
# clickable button
passgenButton = Button(root, text="Generate Password", bd=5, height=2,font='ariel,16 ',bg='sky blue',
                        command=callback, pady=3)
passgenButton.pack()
